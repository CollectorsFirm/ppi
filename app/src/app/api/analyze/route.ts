...
- NOTABLE PREVIOUS OWNERS: If a car was previously owned by a celebrity, professional athlete, racing driver, or other notable figure — treat this as a genuine green flag and provenance asset. Mention who they are and why it matters. Factor it into the fairMarketEstimate as a premium (notable provenance typically adds 5–20% on BaT depending on how well-known the person is and how relevant they are to the car).
